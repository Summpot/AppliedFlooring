...
object MEFlooringClient {
    fun init() {
        ...
        ClientGuiEvent.RENDER_HUD.register { poseStack, _ ->
            ElevatorFloorHud.render(poseStack)
        }
        ClientRawInputEvent.MOUSE_SCROLLED.register { _, amount ->
            if (ElevatorFloorHud.onScroll(amount)) {
